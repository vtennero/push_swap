...
do
  if [[ $line == "Error" ]]; then
  	...
  	printf "${RED}1.[KO] for ${ARG} ${DEF_COLOR}\n";
  	break
  fi
done < test_check.txt
else
...
do
  if [[ $line == "Error" ]]; then
  	...
  	printf "${RED}2.[KO] for ${ARG} ${DEF_COLOR}\n";
  	break
  fi
done < test_check.txt
else
...
do
  if [[ $line == "Error" ]]; then
  	...
  	printf "${RED}3.[KO] for ${ARG} ${DEF_COLOR}\n";
  	break
  fi
done < test_check.txt
else
...
do
  if [[ $line == "Error" ]]; then
  	...
  	printf "${RED}4.[KO] for ${ARG} ${DEF_COLOR}\n";
  	break
  fi
done < test_check.txt
else
...
do
  if [[ $line == "Error" ]]; then
  	...
  	printf "${RED}5.[KO] for ${ARG} ${DEF_COLOR}\n";
  	break
  fi
done < test_check.txt
else
...
do
  if [[ $line == "Error" ]]; then
    ...
    printf "${RED}6.[KO] for ${ARG} ${DEF_COLOR}\n";
    break
  fi
done < test_check.txt
else
...
do
  if [[ $line == "Error" ]]; then
  	...
  	printf "${RED}7.[KO] for ${ARG} ${DEF_COLOR}\n";
  	break
  fi
done < test_check.txt
else
...
do
  if [[ $line == "Error" ]]; then
  	...
  	printf "${RED}8.[KO] for ${ARG} ${DEF_COLOR}\n";
  	break
  fi
done < test_check.txt
else
...
do
  if [[ $line == "Error" ]]; then
  	...
  	printf "${RED}9.[KO] for ${ARG} ${DEF_COLOR}\n";
  	break
  fi
done < test_check.txt
else
...
do
  if [[ $line == "Error" ]]; then
  	...
  	printf "${RED}10.[KO] for ${ARG} ${DEF_COLOR}\n";
  	break
  fi
done < test_check.txt
else
...
do
  if [[ $line == "Error" ]]; then
  	...
  	printf "${RED}11.[KO] for ${ARG} ${DEF_COLOR}\n";
  	break
  fi
done < test_check.txt
else
...
do
  if [[ $line == "Error" ]]; then
  	...
  	printf "${RED}12.[KO] for ${ARG} ${DEF_COLOR}\n";
  	break
  fi
done < test_check.txt
else
...
do
  if [[ $line == "Error" ]]; then
  	...
  	printf "${RED}13.[KO] for ${ARG} ${DEF_COLOR}\n";
  	break
  fi
done < test_check.txt
else
...
do
  if [[ $line == "Error" ]]; then
  	...
  	printf "${RED}14.[KO] for ${ARG} ${DEF_COLOR}\n";
  	break
  fi
done < test_check.txt
else
...
do
  if [[ $line == "Error" ]]; then
  	...
  	printf "${RED}15.[KO] for ${ARG} ${DEF_COLOR}\n";
  	break
  fi
done < test_check.txt
else
...
do
  if [[ $line == "Error" ]]; then
  	...
  	printf "${RED}16.[KO] for ${ARG} ${DEF_COLOR}\n";
  	break
  fi
done < test_check.txt
else
...
do
  if [[ $line == "Error" ]]; then
  	...
  	printf "${RED}17.[KO] for ${ARG} ${DEF_COLOR}\n";
  	break
  fi
done < test_check.txt
else
...
do
  if [[ $line == "Error" ]]; then
  	...
  	printf "${RED}18.[KO] for ${ARG} ${DEF_COLOR}\n";
  	break
  fi
done < test_check.txt
else
...
do
  if [[ $line == "Error" ]]; then
  	...
  	printf "${RED}19.[KO] for ${ARG} ${DEF_COLOR}\n";
  	break
  fi
done < test_check.txt
else
...
do
  if [[ $line == "Error" ]]; then
  	...
  	printf "${RED}20.[KO] for ${ARG} ${DEF_COLOR}\n";
  	break
  fi
done < test_check.txt
else
...
do
  if [[ $line == "Error" ]]; then
  	...
  	printf "${RED}21.[KO] for ${ARG} ${DEF_COLOR}\n";
  	break
  fi
done < test_check.txt
else
...
do
  if [[ $line == "Error" ]]; then
  	...
  	printf "${RED}22.[KO] for ${ARG} ${DEF_COLOR}\n";
  	break
  fi
done < test_check.txt
else
...
do
  if [[ $line == "Error" ]]; then
  	...
  	printf "${RED}23.[KO] for ${ARG} ${DEF_COLOR}\n";
  	break
  fi
done < test_check.txt
else
...
do
  if [[ $line == "Error" ]]; then
  	...
  	printf "${RED}24.[KO] for ${ARG} ${DEF_COLOR}\n";
  	break
  fi
done < test_check.txt
else
...
do
  if [[ $line == "Error" ]]; then
  	...
  	printf "${RED}25.[KO] for ${ARG} ${DEF_COLOR}\n";
  	break
  fi
done < test_check.txt
else
...
do
  if [[ $line == "Error" ]]; then
  	...
  	printf "${RED}26.[KO] for ${ARG} ${DEF_COLOR}\n";
  	break
  fi
done < test_check.txt
else
...
do
  if [[ $line == "Error" ]]; then
  	...
  	printf "${RED}27.[KO] for ${ARG} ${DEF_COLOR}\n";
  	break
  fi
done < test_check.txt
else
...
do
  if [[ $line == "Error" ]]; then
  	...
  	printf "${RED}28.[KO] for ${ARG} ${DEF_COLOR}\n";
  	break
  fi
done < test_check.txt
else
...
do
  if [[ $line == "Error" ]]; then
  	...
  	printf "${RED}29.[KO] for ${ARG} ${DEF_COLOR}\n";
  	break
  fi
done < test_check.txt
else
...
do
  if [[ $line == "Error" ]]; then
  	...
  	printf "${RED}30.[KO] for ${ARG} ${DEF_COLOR}\n";
  	break
  fi
done < test_check.txt
else
...
do
  if [[ $line == "Error" ]]; then
  	...
  	printf "${RED}31.[KO] for ${ARG} ${DEF_COLOR}\n";
  	break
  fi
done < test_check.txt
else
...
do
  if [[ $line == "Error" ]]; then
  	...
  	printf "${RED}32.[KO] for ${ARG} ${DEF_COLOR}\n";
  	break
  fi
done < test_check.txt
else
...
do
  if [[ $line == "Error" ]]; then
  	...
  	printf "${RED}33.[KO] for ${ARG} ${DEF_COLOR}\n";
  	break
  fi
done < test_check.txt
else
...
do
  if [[ $line == "Error" ]]; then
  	...
  	printf "${RED}34.[KO] for ${ARG} ${DEF_COLOR}\n";
  	break
  fi
done < test_check.txt
else
...
do
  if [[ $line == "Error" ]]; then
  	...
  	printf "${RED}35.[KO] for ${ARG} ${DEF_COLOR}\n";
  	break
  fi
done < test_check.txt
else
...
do
  if [[ $line == "Error" ]]; then
    ...
    printf "${RED}36.[KO] for ${ARG} ${DEF_COLOR}\n";
    break
  fi
done < test_check.txt
else
...
do
  if [[ $line == "Error" ]]; then
    ...
    printf "${RED}37.[KO] for ${ARG} ${DEF_COLOR}\n";
    break
  fi
done < test_check.txt
else
...
do
  if [[ $line == "Error" ]]; then
    ...
    printf "${RED}38.[KO] for ${ARG} ${DEF_COLOR}\n";
    break
  fi
done < test_check.txt
else
...
do
  if [[ $line == "Error" ]]; then
    ...
    printf "${RED}39.[KO] for ${ARG} ${DEF_COLOR}\n";
    break
  fi
done < test_check.txt
else
...
do
  if [[ $line == "Error" ]]; then
    ...
    printf "${RED}40.[KO] for ${ARG} ${DEF_COLOR}\n";
    break
  fi
done < test_check.txt
else
...
do
  if [[ $line == "Error" ]]; then
    ...
    printf "${RED}41.[KO] for ${ARG} ${DEF_COLOR}\n";
    break
  fi
done < test_check.txt
else
...
do
  if [[ $line == "Error" ]]; then
    ...
    printf "${RED}42.[KO] for ${ARG} ${DEF_COLOR}\n";
    break
  fi
done < test_check.txt
else
